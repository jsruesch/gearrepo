...
<div class="row footer-sm-buttons"><!-- footer-sm-buttons used to hide from main nav -->
  ...
  <li class="cstbtn"><a href="https://www.youtube.com/channel/UCgVtV1bGua4T2rYjYuELLtg" target="_blank"><i class="fa fa-youtube" aria-hidden="true"></i></a></li>
  <li class="cstbtn"><a href="https://www.instagram.com/gearlearning/" target="_blank"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
</div>
