  ...
  <div class="container-fluid mission-container wow fadeIn">
    <div class="container">
      <div class="row pad60-left pad60-right">
          <h2 class="text-center text-white mission-text wow fadeInUp" data-wow-delay=".45s"><span class="text-green">Gear Learning at UW–Madison<br /></span> designs and develops games to help make complex content <span class="text-green">accessible</span> and <span class="text-green">fun</span>.</h2>
      </div>
    </div>
  </div><!-- END: Mission -->
<!--
