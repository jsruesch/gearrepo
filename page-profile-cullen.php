          ...
          <div class="row bg-ddblue">
            <div class="col-sm-12">
              <div class="profile-link-button">
                <a class="text-center btn-gen" href="mailto:cullen@gearlearning.org" target="_blank"><i class="fa fa-envelope" aria-hidden="true"></i></a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row bg-ddblue pad30">
            <div class="col-sm-4 pad15">
              ...
              <ul class="text-lblue disc">
                <li>GeoBots VR</li>
                <li>DinoTrek VR</li>
                <li>Cosmic Awakening VR</li>
                <li>Dig! for Merge Cube</li>
                <li>THINGS for Merge Cube</li>
                <li>AMNH AR</li>
                <li>Microrangers at AMNH</li>
              </ul>
            </div>
            <div class="col-sm-4 pad15">
