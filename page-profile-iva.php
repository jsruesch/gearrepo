      ...
      <div class="row">
        <div class="col-sm-3">
          ...
          <div class="profile-image-container bg-ddblue">
            ...
            <div class="profile-name">
              <h3 class="text-green">Iva<br />Ivanova</h3>
              <div class="thickdiv mar10-bot mar10-top"></div>
              <h6 class="text-white small bold text-uppercase">2D / 3D Artist</h6>
            </div>
          </div><!-- END: Profile -->
        ...
        <div class="col-sm-9">
          <div class="row pad60">
            <div class="row">
              <p class="text-lblue">
                Hi! My name is Iva. I'm a 3D artist based in Madison, WI where I received my Associates Degree in Applied Arts in Animation from Madison College. I was fortunate enough to join the creative team at Gear Learning right out of college which helped launch my career as a 3D artist. The best part of the job for me is working closely with other outstanding artists who share my passion for game art.              
              </p>
            </div>
          </div>
